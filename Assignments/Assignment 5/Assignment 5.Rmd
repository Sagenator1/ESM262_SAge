...
```{r}
# Running test function in RMarkdown before saving in separate test file
# tests still will not run after I tried fixing the error checking in function
plant_growth = compute_plant_growth(sun = c(5,1,2), water = c(5,1,2))
